...
async def on_message(message):
    ...
    if message.content.startswith("!도박90"):
...
def register(g_content_fun, g_startswith_fun):
    ...
    startswith_key = ["!도박10", "!도박20", "!도박30", "!도박40", "!도박50", "!도박60", "!도박70", "!도박80", "!도박90"]
